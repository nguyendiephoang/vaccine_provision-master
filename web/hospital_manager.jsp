...
<html lang="en">
    ...
    <head>
        <jsp:useBean id ="h" class="DAO.HospitalDAO" scope ="session"></jsp:useBean>
            <meta charset="UTF-8">
                                ...
                                <div class="modal-dialog">
                                    <div class="modal-content">
                                        ...
                                        <div class="modal-footer">
                                            <form action="resetPasswordHospital" method="Post">
                            ...
                            <div class="modal fade" id="editModal${i.idBV}" tabindex="-1" role="dialog" aria-labelledby="editModalLabel"
                                ...
                                <div class="modal-dialog modal-lg" role="document">
                                    <div class="modal-content">
                                        ...
                                        <div class="modal-body">
                                            <!--form chỉnh sửa-->
                                            <form class="form" action="updateHospitalAdmin" method="post"
                                                  id="infor">
                                                <input type="search" value="${i.idBV}" name="idBV" hidden>
