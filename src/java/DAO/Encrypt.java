...
//	
	public static void main(String[] args) throws NoSuchAlgorithmException, NoSuchPaddingException, InvalidKeyException,
		...
		String decryptedCCCD = decryptCCCDTo(encryptCCCD);
		
//		String originalPASS = "123d5678";
//
//		String encryptedPASS = encryptCCCDTo(originalPASS);
//
//		String decryptedPASS = decryptCCCDTo(encryptedPASS);
//		
//		String originalHI = "123456789123456";
//
//		String encryptedHI = encryptCCCDTo(originalHI);
//
//		String decryptedHI = decryptCCCDTo(encryptedHI);

		System.out.println("original cccd test: " + encryptCCCD);
